 ...
 * making it possible to make a single smart contract call to resolve an EVMNS name.
 */
contract UniversalResolver is ERC165, Ownable {
    ...
    EVMNS public immutable registry;

    constructor(address _registry, string[] memory _urls) {
        registry = EVMNS(_registry);
    ...
    /**
     * @dev Performs EVMNS name resolution for the supplied name and resolution data.
     * @param name The name to resolve, in normalised and DNS-encoded form.
     * @param data The resolution data, as specified in EVMNSIP-10.
    ...
    /**
     * @dev Performs EVMNS name reverse resolution for the supplied reverse name.
